...
@onready var lbl_content = $PNL_NotifPopup/CNT_NotifPopup/LBL_Content
@onready var btn_accept = $PNL_NotifPopup/CNT_NotifPopup/BTN_Accept
@onready var btn_refuse = $PNL_NotifPopup/CNT_NotifPopup/BTN_Refuse
